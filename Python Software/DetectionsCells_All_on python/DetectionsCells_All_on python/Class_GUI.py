...
class Class_GUI:
    def Main_GUI():
       ...
       app.geometry("600x800")  # Set the initial size of the window
       ...
       checkbutton2.grid(row=10, column=1, sticky='w',pady =20)
       ...
       checkbutton6.grid(row=9, column=1, sticky='w',pady =10)
